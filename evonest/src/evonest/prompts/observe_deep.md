...
You are in **deep observe mode**. Explore comprehensively:
- Read as many files as needed — no sampling constraint
- Cover all areas: src/, tests/, docs/, config files
- Still reserve the last 2 turns for your JSON output
