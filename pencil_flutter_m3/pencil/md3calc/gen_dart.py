...
def gen_semantic_color_palette(palettes: dict, seed_hex: str) -> str:
    lines = [
        ...
        "// Re-generate: python3 pencil_flutter_m3/pencil/md3calc/gen_dart.py <seed_hex> --out <path>",
        "//",
...
def gen_barrel(barrel_name: str) -> str:
    return (
        ...
        "// Re-generate: python3 pencil_flutter_m3/pencil/md3calc/gen_dart.py <seed_hex> --out <path> --barrel <name>\n"
        "//\n"
