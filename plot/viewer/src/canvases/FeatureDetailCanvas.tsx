 ...
 * per the user's 2026-05-28 FeatureDetail design statement, the
 ...
 * 2026-05-28). The root-service stays in ``doc.feature_ref`` (so
 * `feature/<id>/detail.json` keeps its identity), but the
 * canvas hides it. The tree auto-layout still uses the hidden
 * feature_ref as the BFS hub — that part of D-2026-05-26-G stays.
 *
...
export function FeatureDetailCanvas(props: SketchCanvasProps) {
  return (
    <SketchCanvas
      {...props}
