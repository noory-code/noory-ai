...
If **entity** → run [`plot-entity-template`](../plot-entity-template/SKILL.md)
...
| **AICollaboration** | Cross-cutting agent prompts, MCP tool surface, skills | `plot/agents/`, `plot/skills/`, `plot_mcp/tools/` |
...
`plot-entity-template` or any code edit. Approval pins the placement
...
- [`plot-entity-template`](../plot-entity-template/SKILL.md) —
  ...
  to land it.
- [`plot-feature-tdd`](../plot-feature-tdd/SKILL.md) — runs *after*
  this skill for non-entity changes (rules, behaviour, refactors).
- [`plot-design-red-team`](../plot-design-red-team/SKILL.md) —
