...
# mashbill-feature-tdd — essence-anchored test-first implementation
...
[`mashbill-frontend-bug-diagnosis`](../mashbill-frontend-bug-diagnosis/SKILL.md)
...
### Step 3 — Look up the bounded context in [DOMAIN.md](../../mashbill/docs/DOMAIN.md)
...
### Step 5 — Check [SPEC.md](../../mashbill/docs/SPEC.md) for existing coverage
...
- **Specced for a different behaviour** (proposal contradicts SPEC):
  this is a SPEC change request — invoke [Gate 0](../../mashbill/CLAUDE.md)
  rules. Add a `D-YYYY-MM-DD-X` entry to
  [DECISIONS.md](../../mashbill/docs/DECISIONS.md) **first**, get user
...
(see [`mashbill-frontend-bug-diagnosis`](../mashbill-frontend-bug-diagnosis/SKILL.md)
...
read [Gate 2](../../mashbill/CLAUDE.md)** — those files have a no-growth
ceiling. Put new behaviour in a new file under
`viewer/src/canvases/sketch/` (or other appropriate context dir).

### Step 8 — Browser-verify with the [`mashbill-verifier`](../../mashbill/agents/mashbill-verifier.md) sub-agent

If the change touches UI, invoke the `mashbill-verifier` agent:
...
Per [Gate 0](../../mashbill/CLAUDE.md): user confirmation pins the spec
...
### Step 10 — Commit + push per [Gate 4](../../mashbill/CLAUDE.md)
...
| **Never grow SketchCanvas / SketchInspector / App / SketchStencil.** | Per [Gate 2](../../mashbill/CLAUDE.md). New behaviour → new file in the matching context's directory. |
| **Never auto-emit user-visible state.** | Per [Novel CLAUDE.md rule 7](../../mashbill/CLAUDE.md). All edges, layouts, labels are user-authored unless explicitly approved. |
...
- [`DOMAIN.md`](../../mashbill/docs/DOMAIN.md) — bounded contexts and code homes.
- [`SPEC.md`](../../mashbill/docs/SPEC.md) — current behaviour SSOT.
- [`DECISIONS.md`](../../mashbill/docs/DECISIONS.md) — change-log SSOT.
- [`CLAUDE.md`](../../mashbill/CLAUDE.md) — operational gates that make this skill enforceable.
- [`agents/mashbill-verifier.md`](../../mashbill/agents/mashbill-verifier.md) — Step 8 sub-agent.
- [`mashbill-frontend-bug-diagnosis/SKILL.md`](../mashbill-frontend-bug-diagnosis/SKILL.md) — companion skill for UI bug-fix track.
