...
The detailed SSOT of each principle lives in `principles/`. Principles are not a checklist — they are the criteria that control decisions and behavior at every decision point (`operations/during.md`), in every decision record (`present/work/decisions/`), and in every retrospective.
