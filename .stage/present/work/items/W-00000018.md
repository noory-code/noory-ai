---
id: W-00000018
title: Schema v4 PAST-ANCHORED design freeze
kind: design
venue: claude
parent:
source:
...
# W-00000018 Schema v4 PAST-ANCHORED design freeze

## Purpose

Freeze the schema v4 design agreed in the 2026-07-12 dual debates: topology registry interface, PAST-ANCHORED layout, planned/current/official lifecycle vocabulary, Contract X decision identity, terminal_disposition ownership, migration contract, and roadmap interfaces — as the canonical design document C2-C9 implement against.
