...
This directory owns the SSOT of decision records made at decision points during work.

A working decision is not official truth. Once approved, it is promoted to `official/decisions/records/`.

## Rules

- One decision record has one file.
