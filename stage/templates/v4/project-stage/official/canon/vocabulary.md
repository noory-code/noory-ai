...
| Term | Meaning |
|---|---|
| Official | Promoted, settled truth under the authorization zone. |
| Current | In-progress or provisional artifact lifecycle state. |
| Planned | Intended or proposed artifact lifecycle state. |
